...
public class books_reviews_page {
	...
	ImageIcon hi = new ImageIcon("F:\\Image\\br 40.png");
	...
	void books_rev(String pr_name, int typecode) {
		...
		bg = new JLabel(new ImageIcon("F:\\Image\\br5.jpg"));
		...
		for(int i=0; i<3; i++) {			
			l2 = new JLabel();
			l2.setText(left[i]+"  ==>");
			if(i==0) l2.setBounds(0, pos, 350, 250);
			else l2.setBounds(0, pos, 350, 150);
		...
		int i=0,hor_pos = 400, ver_pos = 150;
			...
			cat1.addMouseListener(new MouseListener() {
				...
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat1) cat1.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat1) cat1.setOpaque(false);
			...
			if(i%4!=0 || i==0) hor_pos = hor_pos + 200;
			else {
				hor_pos = 400;
				ver_pos = ver_pos + 60;
			}
			...
			cat2.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat2) cat2.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat2) cat2.setOpaque(false);
			...
			cat3.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat3) cat3.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat3) cat3.setOpaque(false);
			...
			cat4.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat4) cat4.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat4) cat4.setOpaque(false);
			...
			cat5.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat5) cat5.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat5) cat5.setOpaque(false);
			...
			cat6.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat6) cat6.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat6) cat6.setOpaque(false);
			...
			cat7.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat7) cat7.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat7) cat7.setOpaque(false);
			...
			cat8.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat8) cat8.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat8) cat8.setOpaque(false);
			...
			cat9.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat9) cat9.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat9) cat9.setOpaque(false);
			...
			cat10.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat10) cat10.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat10) cat10.setOpaque(false);
			...
			cat11.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat11) cat11.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat11) cat11.setOpaque(false);
			...
			cat12.addMouseListener(new MouseListener() {
				...
				@Override
				public void mouseEntered(MouseEvent e) {
					if(e.getSource()==cat12) cat12.setOpaque(true);
					
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if(e.getSource()==cat12) cat12.setOpaque(false);
		...
		mb.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				if(e.getSource()==mb) mb.setOpaque(true);
				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				if(e.getSource()==mb) mb.setOpaque(false);
		...
		mp.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				if(e.getSource()==mp) mp.setOpaque(true);
				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				if(e.getSource()==mp) mp.setOpaque(false);
		...
		rev.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				if(e.getSource()==rev) rev.setOpaque(true);
				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				if(e.getSource()==rev) rev.setOpaque(false);
		...
		mr.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				if(e.getSource()==mr) mr.setOpaque(true);
				
			}
			@Override
			public void mouseExited(MouseEvent e) {
				if(e.getSource()==mr) mr.setOpaque(false);
