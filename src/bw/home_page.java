...
public class home_page extends JFrame implements ActionListener{
	...
	ImageIcon hi = new ImageIcon("F:\\Image\\h 40.png");
	ImageIcon img2 = new ImageIcon("F:\\Image\\home5r3.jpg");
	ImageIcon img = new ImageIcon("F:\\Image\\h1.jpg");
...
//		frame.add(panel1);
		...
		pr.addMouseListener(new MouseListener() {
			...
			public void mouseEntered(MouseEvent e) {
				if(e.getSource()==pr) pr.setOpaque(true);
				
			}

			@Override
			public void mouseExited(MouseEvent e) {
				if(e.getSource()==pr) pr.setOpaque(false);
		...
		books.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				if(e.getSource()==books) books.setOpaque(true);
				
			}

			@Override
			public void mouseExited(MouseEvent e) {
				if(e.getSource()==books) books.setOpaque(false);
		...
		wr.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				if(e.getSource()==wr) wr.setOpaque(true);
				
			}

			@Override
			public void mouseExited(MouseEvent e) {
				if(e.getSource()==wr) wr.setOpaque(false);
		...
		pub.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				if(e.getSource()==pub) pub.setOpaque(true);
				
			}

			@Override
			public void mouseExited(MouseEvent e) {
				if(e.getSource()==pub) pub.setOpaque(false);
		...
		logout.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				if(e.getSource()==logout) logout.setOpaque(true);
				
			}

			@Override
			public void mouseExited(MouseEvent e) {
				if(e.getSource()==logout) logout.setOpaque(false);
		...
		exit.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				if(e.getSource()==exit) exit.setOpaque(true);
				
			}

			@Override
			public void mouseExited(MouseEvent e) {
				if(e.getSource()==exit) exit.setOpaque(false);
