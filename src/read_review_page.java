	...
	void read_review(String pr_name, String book_name, int pagetype) throws SQLException {
		...
		if(size!=0) {
			...
			if(pagetype==3) {				
				...
				book_pro.setText("<html>Book Name: <span style=\"font-family:Cambria;font-size:15px;\">"+rs2.getString(2)
							...
							+"</span> <br> Publication: <span style=\"font-family:Cambria;font-size:15px;\">"+rs2.getString(5)
							+"</span> <br> Published in: <span style=\"font-family:Cambria;font-size:15px;\">"+rs2.getString(11)
							+"</span> <br> Five Stars: <span style=\"font-family:Cambria;font-size:15px;\">"+rs2.getInt(6)
							+"</span> <br> Four stars: <span style=\"font-family:Cambria;font-size:15px;\">"+rs2.getInt(7)
							+"</span> <br> Three Stars: <span style=\"font-family:Cambria;font-size:15px;\">"+rs2.getInt(8)
							+"</span> <br> Two Stars: <span style=\"font-family:Cambria;font-size:15px;\">"+rs2.getInt(9)
							+"</span> <br> One Stars: <span style=\"font-family:Cambria;font-size:15px;\">"+rs2.getInt(10)
							+"</span> </html>");
			...
			for(int i=0; i<size; i++,var_pos++) {
				...
				if(rs.getInt(5)==1) star = "*";
				else if(rs.getInt(5)==2) star = "**";
				else if(rs.getInt(5)==3) star ="***";
				else if(rs.getInt(5)==4) star = "****";
				else if(rs.getInt(5)==5) star = "*****";
				else star ="";				
				
				label[i] = new JLabel();
				
				label[i].setText("<html><span style=\"font-family:Comic Sans MS;font-size:15px;\">"+rs.getString(2)
								+"</span> reviewed "+"<span style=\"font-family:Comic Sans MS;font-size:15px;\">"+rs.getString(3)
								+"</span> on topic "+"<span style=\"font-family:Comic Sans MS;font-size:15px;\">"+rs.getString(4)
								+"</span> <br> Rated <span style=\"font-family:Comic Sans MS;font-size:15px;\">"+rs.getInt(5)
								+"</span> stars <span style=\"font-family:Wide Latin;font-size:18px;\">"+star+"</span> <br>"
								+ "Review : <span style=\"font-family:Cambria;font-size:15px;\">"+rs.getString(6)
								+"</span> </html>");
				
				if(rs.getString(6)==null || rs.getString(6).length()<300) label[i].setPreferredSize(new Dimension(750,200));
				else label[i].setPreferredSize(new Dimension(750,300));
